...
$latest_version2 = "2.2.4";
$version = "unknown";

if(isset($_GET['version']))
{
    $version = $_GET['version'];
    if($latest_version == $_GET['version'] || $latest_version2 == $_GET['version'])
        $latest = "true";
    else
        $latest = "false";
}
...
if ($correct ) {
        ...
        $responseArray = array("User" => $profile, "Flights" => $flights, "Hotels" => $hotels, "Scheduler" => $scheduler, "Transport"=>$transport, "Version"=>$latest_version, "TransferInfo" => $transferInfo, "LOE"=>$loeinfo);
